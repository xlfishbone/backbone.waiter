(function (global, factory) {
	...
	(global.Backbone = global.Backbone || {}, global.Backbone.Waiter = factory(global.jQuery));
...
Waiter.mergeOptions = function (options, keys) {
  ...
  underscore.extend(this, underscore.pick(options, keys));
};
...
Waiter.normalizeUIValues = function (hash, ui, properties) {
  underscore.each(hash, function (val, key) {
    ...
    } else if (underscore.isObject(val) && underscore.isArray(properties)) {
      underscore.extend(val, Waiter.normalizeUIValues(underscore.pick(val, properties), ui));
      /* Value is an object, and we got an array of embedded property names to normalize. */
      underscore.each(properties, function (property) {
...
var baseView = backbone.View.extend({
  ...
  normalizeUIKeys: function normalizeUIKeys(hash) {
    ...
    return Waiter.normalizeUIKeys(hash, uiBindings || underscore.result(this, "ui"));
  },
  ...
  normalizeUIValues: function normalizeUIValues(hash, properties) {
    var ui = underscore.result(this, "ui");
    var uiBindings = underscore.result(this, "_uiBindings");
  ...
  _bindUIElements: function _bindUIElements() {
    ...
    var bindings = underscore.result(this, "_uiBindings");
  ...
  _delegateDOMEvents: function _delegateDOMEvents(eventsArg) {
    ...
    if (underscore.isUndefined(eventsArg)) {
      this.events = events;
    }

    var combinedEvents = {};
    underscore.extend(combinedEvents, events);
...
//# sourceMappingURL=backbone.waiter.bundle.js.map
